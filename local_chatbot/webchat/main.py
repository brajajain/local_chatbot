...
conversation = {"Conversation": ["Who are you?", "Hi! I am GPT-3. How can I help you today?"]}
...
def on_init(state: State) -> None:
    ...
    state.conversation = {"Conversation": ["Who are you?", "Hi! I am GPT-3. How can I help you today?"]}
...
def reset_chat(state: State) -> None:
    ...
    Args:
        - state: The current state of the app.
    """
    state.past_conversations = state.past_conversations + [[len(state.past_conversations), state.conversation]]
    state.conversation = {"Conversation": ["Who are you?", "Hi! I am GPT-3. How can I help you today?"]}
...
# Local **Chat**{: .color-primary} # {: .logo-text}
...
if __name__ == "__main__":
    ...
    Gui(page).run(debug=True, dark_mode=True, use_reloader=True, port=5001)
